...
public class LoginDialog extends Dialog
{
	...
	public LoginDialog(Frame parent, boolean modal, String[] services)
	{
	    ...
	    if ( lastServiceName != null ) {
		    serviceNameChoice.select ( lastServiceName.toUpperCase() );
        }
        loginTextfield.setText(	lastLogin );
        pwdTextfield.setText( lastPassword );
        fromTextfield.setText( lastDevice  );
	}
    ...
    */
    public Hashtable<String, String> collectInfo() {
        ...
        lastServiceName = new String(serviceName);
        lastLogin = new String(login);
        lastPassword = new String(password);
        lastDevice = new String(callingExt);
	...
	void loginButton_ActionPerformed(java.awt.event.ActionEvent event)
	{
		try {
			...
			((AutoAnswerFrame)parentFrame).login ( args);
			dispose();
		} catch (Exception e) {
		}
	}
